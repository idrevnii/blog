...
<table data-midas-disagreements="true">
  ...
  <tbody>{['fixed·price_blind', 'agent·price_blind'].map(cell => (
    <tr>
      ...
      <td class="numeric">{deepDive.summary.disagreements[cell].opposite.n}</td>
      <td class="numeric">{deepDive.summary.disagreements[cell].opposite.model_correct}</td>
      <td class="numeric">{deepDive.summary.disagreements[cell].opposite.series}</td>
    </tr>
  ))}</tbody>
</table>
...
<table class="compact-comparison" data-midas-cost="true">
  ...
  <tbody>{facts.insights.configuration_costs.configurations.slice(0, 3).map(row => (
    <tr>
      <td><span class="model-name">{row.model}</span><br />{row.cell === 'fixed·odds_aware' ? 'Fixed context' : 'Agent'} · with odds</td>
      <td class="numeric">{fmt(row.brier, 'en', 4)}</td>
      <td class="numeric">${fmt(row.total, 'en', 3)}</td>
    </tr>
  ))}</tbody>
</table>
...
<table data-midas-profit="true">
  ...
  <tbody>{['champion_wins', 'other_series'].map(key => (
    <tr>
      ...
      <td class="numeric">{deepDive.summary.money[key].n}</td>
      <td class="numeric">{fmt(deepDive.summary.money[key].stake, 'en')}</td>
      <td class="numeric">{fmt(deepDive.summary.money[key].profit, 'en')}</td>
    </tr>
  ))}</tbody>
</table>
...
|---|---:|---:|---:|
| Below <span class="numeric">2.0</span> | <span class="numeric">236</span> | <span class="numeric">257.3</span> | <span class="numeric">+2.9%</span> |
| At least <span class="numeric">2.0</span> | <span class="numeric">274</span> | <span class="numeric">250.7</span> | <span class="numeric">−60.0%</span> |
...
<table class="compact-comparison" data-midas-stakes="true">
  ...
  <tbody>{facts.insights.stake_sizing.models.map(row => (
    <tr>
      ...
      <td class="numeric">{fmt(row.flat_roi * 100, 'en')}%</td>
      <td class="numeric">{fmt(row.weighted_roi * 100, 'en')}%</td>
    </tr>
  ))}</tbody>
</table>
...
<table>
  <thead><tr><th>Configuration</th><th><span class="model-name">Astra</span> Brier ↓</th><th><span class="model-name">Sol</span> Brier ↓</th><th>Early market ↓</th></tr></thead>
  <tbody>{['price_blind', 'odds_aware'].map(variant => (
    <tr>
      <td>{variant === 'price_blind' ? 'Without odds' : 'With odds'}</td>
      <td class="numeric">{fmt(facts.replay.summary[variant].brier, 'en', 4)}</td>
      <td class="numeric">{fmt(facts.replay.summary[variant].reference.brier, 'en', 4)}</td>
      <td class="numeric">{fmt(facts.replay.summary[variant].market.brier, 'en', 4)}</td>
    </tr>
  ))}</tbody>
</table>
